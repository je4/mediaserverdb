...
var file_dbcontroller_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xb1, 0x03, 0x0a, 0x0c, 0x44, 0x42,
...
var file_dbcontroller_proto_depIdxs = []int32{
	...
	5, // 5: mediaserverdbproto.DBController.Ping:output_type -> mediaserverdbproto.DefaultResponse
	6, // 6: mediaserverdbproto.DBController.GetStorage:output_type -> mediaserverdbproto.Storage
	7, // 7: mediaserverdbproto.DBController.GetCollection:output_type -> mediaserverdbproto.Collection
	5, // 8: mediaserverdbproto.DBController.CreateItem:output_type -> mediaserverdbproto.DefaultResponse
	5, // 9: mediaserverdbproto.DBController.DeleteItem:output_type -> mediaserverdbproto.DefaultResponse
